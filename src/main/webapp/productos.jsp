            ...
            <form action="productos" method="get">
                ...
                <select name="categoria" onchange="this.form.submit()">
                    ...
                    <% for(String cat : categoria) { %>
                        <option value="<%= categoria %>" <%= (categoria.equals(categoriaActual) ? "selected" : "") %>>
                            <%= cat %>
                        </option>
                    <% } %>
                </select>
        ...
        <div class="paginacion">
            <% if(totalPaginas > 1) { %>
                <p>
                    ...
                    <% if(paginaActual > 1) { %>
                        <a href="productos?pagina=<%= paginaActual - 1 %><%= (categoriaActual != null ? "&categoria=" + categoriaActual : "") %>">Anterior</a>
                    <% } %>
                    ...
                    <% if(paginaActual < totalPaginas) { %>
                        <a href="productos?pagina=<%= paginaActual + 1 %><%= (categoriaActual != null ? "&categoria=" + categoriaActual : "") %>">Siguiente</a>
                    <% } %>
                </p>
            <% } %>
        </div>
